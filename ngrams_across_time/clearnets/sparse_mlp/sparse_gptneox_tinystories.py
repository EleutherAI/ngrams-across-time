...
from ngrams_across_time.clearnets.sparse_mlp.sparse_gptneox import (
    SparseGPTNeoConfig,
...
def main():
    ...
    if not os.path.exists("data/tinystories/restricted_tokenizer_v2"):
        ...
        tokenizer = AutoTokenizer.from_pretrained(
            "data/tinystories/restricted_tokenizer_v2"
        )
    ...
    train_dataset = train_dataset.map(
        tokenize,
        batched=True,
        cache_file_name="data/tinystories/train_dataset_v2.cache",
    )
    ...
    val_dataset = val_dataset.map(
        tokenize, batched=True, cache_file_name="data/tinystories/val_dataset_v2.cache"
    )
