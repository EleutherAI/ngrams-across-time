...
def main():
    ...
    def add_scores_if_exists(fig, key: str, score_type: str | None, name: str, checkpoint_data, normalize: bool = True):
    ...
    def add_seed_scores_if_exists(
        ...
        fig.add_trace(go.Scatter(
            x=checkpoint_epochs, y=mean_scores, mode='lines', name=f"Mean {name}",
            line=line_dict
        ))
    ...
    fig.write_image(images_path / f'node_sae_entropies.pdf', format='pdf')
